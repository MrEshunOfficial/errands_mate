...
export default function ProviderDashboard() {
  ...
  if (profileLoading) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 flex items-center justify-center min-h-64 sm:min-h-100">
